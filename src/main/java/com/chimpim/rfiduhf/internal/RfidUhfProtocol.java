...
public interface RfidUhfProtocol {
     ...
     */
    @NotNull
    byte[] setBaudRate(byte address, byte baudRate);
     ...
     */
    @NotNull
    byte[] getFirmwareVersion(byte address);
     ...
     */
    @NotNull
    byte[] setRF(byte address, byte power, byte freq);
     ...
     */
    @NotNull
    byte[] setWorkAntenna(byte address, byte antCfg);
     ...
     */
    @NotNull
    byte[] getWorkAntenna(byte address);
     ...
     */
    @NotNull
    byte[] isoMultiTagIdentify(byte address);
     ...
     */
    @NotNull
    byte[] isoMultiTagRead(byte address, byte startAddr);
     ...
     */
    @NotNull
    byte[] isoWrite(byte address, byte addr, byte value);
     ...
     */
    @NotNull
    byte[] isoReadWithUID(byte address, byte[] uid, byte addr);
     ...
     */
    @NotNull
    byte[] isoWriteWithUID(byte address, byte[] uid, byte addr, byte value);
     ...
     */
    @NotNull
    byte[] isoLock(byte address, byte addr);
     ...
     */
    @NotNull
    byte[] isoQueryLock(byte address, byte addr);
     ...
     */
    @NotNull
    byte[] isoBlockWrite(byte address, byte addr, byte[] value);
     ...
     */
    @NotNull
    byte[] isoSingleTagRead(byte address, byte addr);
     ...
     */
    @NotNull
    byte[] gen2MultiTagIdentify(byte address);
     ...
     */
    @NotNull
    byte[] gen2EPCWrite(byte address, byte addr, byte[] value);
     ...
     */
    @NotNull
    byte[] gen2Lock(byte address, byte memBank, byte control);
     ...
     */
    @NotNull
    byte[] gen2Kill(byte address, byte[] password);
     ...
     */
    @NotNull
    byte[] gen2Init(byte address, byte bitCount);
     ...
     */
    @NotNull
    byte[] gen2Read(byte address, byte memBank, byte addr, byte len);
     ...
     */
    @NotNull
    byte[] gen2Write(byte address, byte memBank, byte addr, byte[] value);
     ...
     */
    @NotNull
    byte[] getIDAndDelete(byte address, byte tagCount);
     ...
     */
    @NotNull
    byte[] queryIDCount(byte address);
     ...
     */
    @NotNull
    byte[] clearIDBuffer(byte address);
